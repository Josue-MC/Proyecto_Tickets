<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="tickets_Terminados.aspx.cs" Inherits="Proyecto_Tickets.Ticket.tickets_Terminados" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Consulta de Tickets Terminados. <small></small><asp:Label ID="lblFecha" runat="server" CssClass="pull-right" Text="Label"></asp:Label></h1>
    </section>
                  ...
                  <h3 class="box-title">Tickets <strong><asp:Label ID="lblNivel" runat="server" Text="Label"></asp:Label></strong>  de soporte.</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <asp:Button ID="btnconsultar" CssClass="form-control" runat="server" Text="Button"  AutoPostBack="false" />
                           </div>
                        </div>
                         -->
                        <br />
                        <asp:GridView ID="grdTickets" AutoGenerateColumns="false" runat="server" CssClass="table table-bordered table-striped dataTable" OnRowCommand="grdTickets_RowCommand" EmptyDataText="No existen Tickets asociados." >
                            <Columns>
                                <asp:TemplateField >
                                <ItemTemplate>
                                    <asp:Button ID="btnEditar" class="btn btn-block btn-default" runat="server" Text="Detalles" CommandName="Editar1"  CommandArgument='<%# Eval("ID_Ticket") %>' UseSubmitBehavior="false" />
                                </ItemTemplate>
                            </asp:TemplateField>
