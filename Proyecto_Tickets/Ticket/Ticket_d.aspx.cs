...
{
    public partial class Ticket_d : System.Web.UI.Page
    {
        ...
        protected void btnEliminarTicket_Click(object sender, EventArgs e)
        {
            eliminarTicket();
            ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "Eliminar", "alert('Ticket Eliminado Exitosamente.')", true);
